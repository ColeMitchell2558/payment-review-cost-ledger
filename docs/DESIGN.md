...
> Design notes for **payment-review-cost-ledger** — a runnable python example that A typed Python service that records model cost beside each creator payout decision.
...
- **Feature code** — the actual task: payment-cost-review.
